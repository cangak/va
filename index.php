  ...
  <div class="modal-dialog">
        ...
        <div class="modal-content">
             <div class="modal-header">
                  <h4 class="modal-title">NIM VA</h4>
...
<!-- modal end -->
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    <div class="container-fluid d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center me-auto me-xl-0">
        ...
        <img src="https://polnep.ac.id/images/logotop.png" alt="">
        <!-- <h1>Append</h1> -->
        <span>.</span>
      </a>
  ...
  <main id="main">
    ...
    <section id="hero" class="hero">
      ...
      <img src="https://polnep.ac.id/uploads/header/mTIth0ndZU.jpg" alt="" data-aos="fade-in">

      <div class="container">
        <div class="row">
          <div class="col-lg-10">
            <h2 data-aos="fade-up" data-aos-delay="100">VA cek</h2>
            <p data-aos="fade-up" data-aos-delay="200">Silahkan cek nilai VA anda dengan menginput NIM</p>
          </div>
          <div class="col-lg-5">
            <form action="#" class="sign-up-form d-flex" data-aos="fade-up" data-aos-delay="300">
              <input type="text" class="nim form-control" placeholder="NIM">
              <input type="submit" class="ceknim btn btn-primary" value="CEK">
            </form>
          </div>
        </div>
      </div>
